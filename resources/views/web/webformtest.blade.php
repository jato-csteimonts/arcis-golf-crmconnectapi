...
@section('content')
    ...
    <script src="https://crmconnectapi.dev/webform-javascript"></script>
...
<form class="entityform entitytype-membership_inquiry-form" action="/membership/golf" method="post" id="membership-inquiry-entityform-edit-form" accept-charset="UTF-8"><div><div class='pre-instructions' ></div><input type="hidden" name="form_build_id" value="form-HWVdKyZs3zpNGDDVaMvjH6wBoHDdljO1Yh9Pq_mXFkE" />
        ...
        <div class="field-type-text field-name-field-first-name field-widget-text-textfield form-wrapper form-group" id="edit-field-first-name"><div id="field-first-name-add-more-wrapper"><div class="form-type-textfield form-item-field-first-name-und-0-value form-item form-group">
                    ...
                    <input class="text-full form-control form-text required" type="text" id="edit-field-first-name-und-0-value" name="field_first_name" value="" size="60" maxlength="255" />
                </div>
                    ...
                    <input class="text-full form-control form-text required" type="text" id="edit-field-last-name-und-0-value" name="field_last_name" value="" size="60" maxlength="255" />
                </div>
                        ...
                        <input class="form-control form-text required" type="text" id="edit-field-email-und-0-email" name="field_email" value="" size="60" maxlength="128" />
                    </div>
                    ...
                    <input class="text-full form-control form-text required" type="text" id="edit-field-phone-number-und-0-value" name="field_phone_number" value="" size="60" maxlength="255" />
                </div>
                ...
                <select class="form-control form-select required" id="edit-field-hear-und" name="field_hear"><option value="_none">- Select a value -</option><option value="Contacted by the Club">Contacted by the Club</option><option value="Direct Email">Direct Email</option><option value="Existing Member">Existing Member</option><option value="Facebook">Facebook</option><option value="Twitter">Twitter</option><option value="Google AdWords">Google AdWords</option><option value="Tri-Valley CVB">Tri-Valley CVB</option><option value="Other">Other</option></select>
            </div>
                ...
                <select class="form-control form-select required" id="edit-field-membership-type-checkbox-und" name="field_membership_type_checkbox"><option value="_none">- Select a value -</option><option value="Golf">Golf</option><option value="Junior Executive">Junior Executive</option><option value="Sports">Sports</option><option value="Social">Social</option><option value="Dining">Dining</option></select>
            </div>
                    ...
                    <div class="form-textarea-wrapper resizable"><textarea class="text-full form-control form-textarea" id="edit-field-comments-und-0-value" name="field_comments" cols="60" rows="5"></textarea></div>
                </div>
